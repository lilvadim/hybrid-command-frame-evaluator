...
class CommandSemanticsAnalyzerTest {
    ...
    @Test
    fun commandSemantics() {
        val commandSemantics = uut.commandSemantics(lsCommand)
        println(commandSemantics.optionSemantics(OptionRef("-f")))
        println(commandSemantics.optionSemantics(OptionRef("-w")))
    }
}